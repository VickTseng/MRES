...
for(var i=0; i<3; i++){		//對抓取的分數進行擴分	
	switch(temp_fraction.denom[i]){
		case 2:				
			...
			//rand_number(1,8,3,extend);
			extend[0] = 10, extend[1] = 11, extend[2] = 12;
			for(var j=0; j<3;j++){
		...
		case 3:
			var extend = [];	//儲存擴分的大小數值
			//rand_number(1,10,3,extend);
			extend[0] = 7, extend[1] = 8, extend[2] = 9;
			for(var j=0; j<3;j++){
				question_fraction.nume.push(temp_fraction.nume[i] * extend[j]);
				question_fraction.denom.push(temp_fraction.denom[i] * extend[j]);
				question_fraction.original_nume.push(temp_fraction.nume[i]);
		...
		case 4:
			var extend = [];	//儲存擴分的大小數值
			//rand_number(1,7,3,extend);
			extend[0] = 5, extend[1] = 6, extend[2] = 7;
			for(var j=0; j<3;j++){
				question_fraction.nume.push(temp_fraction.nume[i] * extend[j]);
				question_fraction.denom.push(temp_fraction.denom[i] * extend[j]);
				question_fraction.original_nume.push(temp_fraction.nume[i]);
		...
		case 5:
			...
			extend[0] = 4, extend[1] = 5, extend[2] = 6;
			for(var j=0; j<3;j++){
				question_fraction.nume.push(temp_fraction.nume[i] * extend[j]);
				question_fraction.denom.push(temp_fraction.denom[i] * extend[j]);
				question_fraction.original_nume.push(temp_fraction.nume[i]);
		...
		case 6:
			var extend = [];	//儲存擴分的大小數值
			//rand_number(1,5,3,extend);
			extend[0] = 3, extend[1] = 4, extend[2] = 5;
			for(var j=0; j<3;j++){
				question_fraction.nume.push(temp_fraction.nume[i] * extend[j]);
				question_fraction.denom.push(temp_fraction.denom[i] * extend[j]);
				question_fraction.original_nume.push(temp_fraction.nume[i]);
...
for(var i =2;i<question_fraction.max_extend[0]; i++){	//儲存第一道題目
...
for(var i =2;i<question_fraction.max_extend[0]; i++){	//儲存第二道題目
...
for(var i =2;i<question_fraction.max_extend[0]; i++){	//儲存第三道題目
