...
function initial(){		
	...
	window.onload = function(){	//載入頁面時，將圖卡及字符配對好
		correctCouple();
		$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_question.php", 
		...
		$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_member_card.php", 
...
function check(){	//判斷對錯
	...
	if(block1.use == false && block2.use == false && block66.use == false){		//假如三個空格的值都填對了
		...
		$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_total_time.php", 
		{time: data_log.time, date:now.toString().substring(0,33), ques: switchSymbol(ques_index)});//儲存此題的完成時間
		data_log.time = 0; //將時間歸零
		
		$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_trans_times.php", 
		...
		$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_operate_times.php", 
					...
					case "personal_panel":
						switch(blockArray[i].id){	//驗證面板的操作
							...
							case "A_close":
								...
								$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_trans_cancel_times.php", 
							...
							case "A_confirm":
								if(blockArray[i].use == true){
									...
									handleObj.scaleCentralArea();	//控制中央面板大小	
									clearTimeout(A_trans_time); //停止計算轉換時間
									$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_trans_time.php", 
									...
									$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_trans_error_times.php",
									{date:now.toString().substring(0,33), ques: switchSymbol(ques_index),
									...
									$.post("../mathematic/myphp/equivalence_data/B_collect_data/equivalence_B_trans_previous_times.php",
									{date:now.toString().substring(0,33), ques: switchSymbol(ques_index),
